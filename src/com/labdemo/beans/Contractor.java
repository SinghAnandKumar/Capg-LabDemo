...
public class Contractor {
	...
	TreeMap<EmployeeKey,ContractBasedEmployee> CBEmployees = null;
	...
	public Contractor(String name) {
		this.name = name;
		CBEmployees = new TreeMap<EmployeeKey,ContractBasedEmployee>();
	}
	...
	public TreeMap<EmployeeKey,ContractBasedEmployee> getCBEmployees() {
		return CBEmployees;
	}
