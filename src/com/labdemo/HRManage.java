...
class HRManage {
	static TreeMap<EmployeeKey, PermanentEmployee> permEmployees = new TreeMap<EmployeeKey, PermanentEmployee>();
	static TreeMap<String, Contractor> contractors = new TreeMap<String, Contractor>();
