...
public class Statistics {
	...
	TreeMap<EmployeeKey, PermanentEmployee> permEmployees = null;
	TreeMap<String, Contractor> contractors = null;
	String employeeNotFoundMessage = "Error while searching Employee. No Employee with this employee ID ";

	public Statistics(TreeMap<EmployeeKey, PermanentEmployee> permEmployees, TreeMap<String, Contractor> contractors) {
	...
	public ContractBasedEmployee searchContractBasedEmplyee(Contractor c, EmployeeKey Key) throws EmployeeNotPresentEmployee {
		TreeMap<EmployeeKey, ContractBasedEmployee> CBEmployees = c.getCBEmployees();
